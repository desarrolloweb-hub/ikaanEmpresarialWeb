...
- **Repo:** `desarrolloweb-hub/ikaanEmpresarialWeb`
- **Publicado en:** GitHub Pages — `https://desarrolloweb-hub.github.io/ikaanEmpresarialWeb/`
...
- `github.md` apunta a `socialmediamqt/Ikaan`, el repo de donde se importó el proyecto. El
  remoto real hoy es `desarrolloweb-hub/ikaanEmpresarialWeb`.
